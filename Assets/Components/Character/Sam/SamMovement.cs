...
public class SamMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Horizontal movement
        rb.linearVelocity = new Vector2(horizontalMovement * moveSpeed, rb.linearVelocity.y); // using velocity instead of linearVelocity

        // Jumping
        if (jumpPressed && isGrounded)
        {
            rb.linearVelocity = new Vector2(rb.linearVelocity.x, jumpForce); // jump force applied to y velocity
        ...
        // Animation
        animator.SetFloat("Speed", Mathf.Abs(horizontalMovement)); // This is fine as long as horizontalMovement updates
    ...
    public void OnJump(InputAction.CallbackContext context)
    {
        ...
        {
            jumpPressed = true; // Flag jump to be processed in Update
        }
    }
